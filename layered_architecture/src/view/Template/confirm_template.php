        ...
        <form action="" method="POST">
            ...
            <section class="contact_sheet">
                ...
                <table>
                    ...
                    <tr class="kana_area">
                        <th>フリガナ</th>
                        <td><?php echo h($form_data['kana']); ?></td>
                    </tr>
                    <tr class="sex_area">
                        <th>性別</th>
                        <td><?php echo h($sex[$form_data['sex']]); ?></td>
                    </tr>
                    <tr class="age_area">
                        <th>年齢</th>
                        <td><?php echo h($age[$form_data['age']]); ?></td>
                    </tr>
                    <tr class="blood_type_area">
                        <th>血液型</th>
                        <td><?php echo h($blood_type[$form_data['blood_type']]); ?></td>
                    </tr>
                    <tr class="job_area">
                        <th>職業</th>
                        <td><?php echo h($job[$form_data['job']]); ?></td>
                    </tr>
                    <tr class="post_code_area">
                        <th>郵便番号</th>
                        <td><?php echo h($form_data['post_code']); ?></td>
                    </tr>
                    <tr class="address_area">
                        <th>住所</th>
                        <td><?php echo h($form_data['pref']); ?></td>
                    </tr>
                    <tr class="address_other_area">
                        <th>ビル・マンション名</th>
                        <td><?php echo h($form_data['address_other']); ?></td>
                    </tr>
                    <tr class="phone_number_area">
                        <th>電話番号</th>
                        <td><?php echo h($form_data['phone_number']); ?></td>
                    </tr>
                    <tr class="mail_area">
                        <th>メールアドレス</th>
                        <td><?php echo h($form_data['mail']); ?></td>
                    </tr>
                    ...
                    <tr class="contact_content_area">
                        <th>お問い合わせ</th>
                        <td><?php echo nl2br(h($form_data['contact_content'])); ?></td>
                    </tr>
                </table>
            </section>
